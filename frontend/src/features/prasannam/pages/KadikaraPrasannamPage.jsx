...
export default function KadikaraPrasannamPage() {
  ...
  const breadcrumbsList = [
    ...
    { name: t('astrology:kadikara.prasannam', currentLang === 'ta' ? 'பிரசன்னம்' : 'Prasannam'), path: '/prasannam/kadikara-clock' },
    { name: t('astrology:kadikara.pageTitle', currentLang === 'ta' ? 'கடிகார பிரசன்னம்' : 'Kadikara Prasannam'), path: '/prasannam/kadikara-clock' }
  ];
