...
export default function NakshatraPadasPage() {
  ...
  return (
    <div className="prokerala-layout-container">
      <SEOHead
        pageKey="nakshatras"
        title="108 Nakshatra Padas (நட்சத்திர மண்டலம்) - South Indian Star Wheel"
        description="Authentic South Indian 4x4 Nakshatra Mandalam chart connecting 12 Rasis, 27 Stars, and 108 Padas with exact 1-30° Rasi and 0-360° Zodiac degree spans."
        breadcrumbs={[
          { name: 'Home', path: '/' },
          { name: 'Zodiac & Planets', path: '/nakshatras' },
          { name: '108 Nakshatra Padas', path: '/nakshatra-padas' }
        ]}
      />
