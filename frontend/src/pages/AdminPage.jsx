...
import { TABLE_CONFIGS, getTableConfig } from '../features/admin/config/tableSchemas.config';
import AdminSidebar from '../features/admin/components/AdminSidebar';
import AdminDashboard from '../features/admin/components/AdminDashboard';
import DataTable from '../features/admin/components/DataTable';
import RecordModal from '../features/admin/components/RecordModal';
import RecordDetailModal from '../features/admin/components/RecordDetailModal';
import DeleteConfirmModal from '../features/admin/components/DeleteConfirmModal';
import PermissionManager from '../features/admin/components/PermissionManager';
