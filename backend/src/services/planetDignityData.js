...
export const TATKALIKA_RULES_DATA = {
  ...
  compoundTable: [
    {
      naturalTa: 'நைசர்கிக மித்துரு',
      temporalTa: 'தற்கால மித்துரு',
      compoundTa: 'அதி மித்துரு',
